...
SLIDES = {
    ...
    28: ("politika_konfidentsialnosti", "Пять вопросов к политике конфиденциальности сервиса"),
    29: ("gan_avtokodirovshchik", "Как технически создаются подделки: автокодировщики и GAN"),
    30: ("152fz_shtrafy_2025", "152-ФЗ: во сколько раз выросла ответственность за утечку"),
}
